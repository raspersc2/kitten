...
from bot.squad_agent.architecture.dqn.model import Model
from bot.squad_agent.architecture.dqn.replay_buffer import (
...
class DQNAgent(BaseAgent):
    def __init__(self, ai: BotAIExt, config: Dict, pathing: Pathing) -> None:
        ...
        # save model, since we need to reset the update steps
        save_checkpoint(
